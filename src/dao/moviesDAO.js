...
export default class MoviesDAO {
  ...
  static async getMoviesByCountry(countries) {
    //console.log(`getMoviesByCountry function - param countries is ${countries}`)
    /**
    Ticket: Projection
  ...
  static castSearchQuery(cast) {
    //console.log(`castSearchQuery function - param cast is ${cast}`)
    const searchCast = Array.isArray(cast) ? cast : Array(cast)
    //console.log(`castSearchQuery function - searchCast is ${searchCast}`)
  ...
  static genreSearchQuery(genre) {
    ...
    */
    //console.log(`genreSearchQuery function - param genre is ${genre}`)
    const searchGenre = Array.isArray(genre) ? genre : Array(genre)
    //console.log(`genreSearchQuery function - searchGenre is ${searchGenre}`)
